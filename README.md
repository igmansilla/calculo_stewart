...
│    ├── Stewart_Calculo_Completo.pdf
    ...
    │   ├── Stewart_Seccion_2_3_Razones_de_Cambio_en_las_Ciencias_Fisicas_y_Sociales.pdf
    │   ├── Stewart_Seccion_2_4_Derivadas_de_Funciones_Trigonometricas.pdf
...
├── limites_y_continuidad/               # Límites y Continuidad (Capítulo 1)
│   ├── capitulo_01.tex                  # Índice de secciones del Capítulo 1
│   ├── seccion_01_1/                    # Sección 1.1: El Problema de la Tangente y de la Velocidad
...
- **Sección 0.1 independiente (`seccion_0_1_standalone.tex` en `capitulo_0/seccion_0_1/`)**:
  ...
  ```
- **Sección 1.1 independiente (`seccion_01_1_standalone.tex` en `limites_y_continuidad/seccion_01_1/`)**:
  ```bash
  ./build.py --target seccion_1_1
  ```
- **Sección 1.2 independiente (`seccion_01_2_standalone.tex` en `limites_y_continuidad/seccion_01_2/`)**:
  ```bash
  ./build.py --target seccion_1_2
  ```
- **Sección 1.3 independiente (`seccion_01_3_standalone.tex` en `limites_y_continuidad/seccion_01_3/`)**:
  ```bash
  ./build.py --target seccion_1_3
  ```
- **Sección 1.4 independiente (`seccion_01_4_standalone.tex` en `limites_y_continuidad/seccion_01_4/`)**:
  ```bash
  ./build.py --target seccion_1_4
  ```
...
- **Sección 2.2 independiente (`seccion_02_2_standalone.tex` en `derivadas/seccion_02_2/`)**:
  ...
  ```
- **Sección 2.3 independiente (`seccion_02_3_standalone.tex` en `derivadas/seccion_02_3/`)**:
  ```bash
  ./build.py --target seccion_2_3
  ```
- **Sección 2.4 independiente (`seccion_02_4_standalone.tex` en `derivadas/seccion_02_4/`)**:
  ```bash
  ./build.py --target seccion_2_4
  ```
- **Sección 2.5 independiente (`seccion_02_5_standalone.tex` en `derivadas/seccion_02_5/`)**:
  ```bash
  ./build.py --target seccion_2_5
  ```
- **Sección 2.6 independiente (`seccion_02_6_standalone.tex` en `derivadas/seccion_02_6/`)**:
  ```bash
  ./build.py --target seccion_2_6
  ```
- **Sección 2.7 independiente (`seccion_02_7_standalone.tex` en `derivadas/seccion_02_7/`)**:
  ```bash
  ./build.py --target seccion_2_7
  ```
