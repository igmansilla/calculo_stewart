...
\subsection*{SECCIÓN 9.1 \quad Ejercicios}

\noindent\textbf{En los ejercicios 1-20, (a) trace la gráfica de la curva representada por las ecuaciones paramétricas dadas y (b) elimine el parámetro para encontrar la ecuación cartesiana de la curva.}
\begin{enumerate}
...
\vspace{0.5cm}
\noindent\textbf{En los ejercicios 21-26 describa el movimiento de una partícula cuya posición es el punto $(x, y)$ cuando $t$ varía en el intervalo dado.}
\begin{enumerate}
    \setcounter{enumi}{20}
...
\vspace{0.5cm}
\noindent\textbf{En los ejercicios 27-30 trace la gráfica de la curva representada por las ecuaciones paramétricas dadas.}
\begin{enumerate}
    \setcounter{enumi}{26}
