...
\noindent\textbf{En los ejercicios 1-8 encuentre el vértice, foco y directriz de la parábola dada y trace su gráfica.}
\begin{enumerate}
...
\vspace{0.3cm}
\noindent\textbf{En los ejercicios 9-20 encuentre los vértices y focos de la cónica dada y trace su gráfica. En el caso de una hipérbola, determine las asíntotas.}
\begin{enumerate}
    \setcounter{enumi}{8}
...
\vspace{0.3cm}
\noindent\textbf{En los ejercicios 21-38 encuentre una ecuación de la cónica que satisfaga las condiciones dadas.}
\begin{enumerate}
    \setcounter{enumi}{20}
...
\vspace{0.3cm}
\noindent\textbf{Ejercicios Aplicados:}
\begin{enumerate}
    \setcounter{enumi}{38}
