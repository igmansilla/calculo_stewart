...
\subsection*{SECCIÓN 7.4 \quad Ejercicios}

\noindent\textbf{En los ejercicios 1-18 escriba la forma de la descomposición en fracciones parciales de la función dada (como en el ejemplo 7). No determine los valores numéricos de los coeficientes.}
\begin{enumerate}
...
\vspace{0.5cm}
\noindent\textbf{Evalúe las integrales dadas en los ejercicios 19-64.}
\begin{enumerate}
    \setcounter{enumi}{18}
...
\vspace{0.5cm}
\noindent\textbf{En los ejercicios 66-69 evalúe la integral dada completando el cuadrado y empleando la fórmula 7.20 o la fórmula del ejercicio 65.}
\begin{enumerate}
    \setcounter{enumi}{65}
...
\vspace{0.5cm}
\noindent\textbf{En los ejercicios 70-72 encuentre el área de la región comprendida bajo la curva dada de $a$ a $b$.}
\begin{enumerate}
    \setcounter{enumi}{69}
