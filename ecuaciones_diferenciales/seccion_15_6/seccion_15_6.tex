...
\subsection*{Ejercicios 1--12: Resolución de ecuaciones de segundo orden no homogéneas y PVI mediante Coeficientes Indeterminados.}
\begin{enumerate}
...
\subsection*{Ejercicios 13--16: Propuesta conceptual de la solución de prueba (forma particular ansatz) para Coeficientes Indeterminados.}
\begin{enumerate}
    \setcounter{enumi}{12}
...
\subsection*{Ejercicios 17--20: Métodos comparativos: resolución por Coeficientes Indeterminados y Variación de Parámetros.}
\begin{enumerate}
    \setcounter{enumi}{16}
...
\subsection*{Ejercicios 21--26: Resolución analítica de ecuaciones de segundo orden no homogéneas por Variación de Parámetros.}
\begin{enumerate}
    \setcounter{enumi}{20}
